...
const projects = [
    ...
    { title: "Bdd Agricole", image: "/images/premannee/bdd_cereals.png", content:"Réalisation d'une base de données complexe en SQL.\n Le but principal était de créer une base de données solide afin de permettre à une organisation agricole de gérer ses flux entrants et sortants, ses stocks, ses ventes, et même de gérer ce qui était bénéfique ou non.\n Ce projet s'étend sur l'année entière et visait à nous mettre en jambes dans l'usage de SQL et de nous initier à tous ses concepts, requêtes, triggers, procédures stockées, etc..." },
    { title: "Sites Web", image: "/images/premannee/siteweb.jpg", content:"Création de deux sites web dans le cadre des projets semestriels.\n L'objectif de cette création était surtout de nous initier au travail d'équipe et à la gestion de projet dans le cadre d'une expérience avec de nouveaux individus.(images non-représentatives du travail effectué)\n Ainsi, le premier site a été réalisé intégralement en HTML5 CSS3 alors que le second implémentait aussi du JavaScript pour le rendre plus dynamique et agréable aux utilisateurs." }
];
