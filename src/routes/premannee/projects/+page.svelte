<script lang="ts">
    ...
    import { base } from '$app/paths'; // Import the base path for images

    let projects = [];
    $: projects = $page.data.projects; // Access projects from the page store
...
<h1 class="text-center text-4xl mt-8 font-extrabold mb-8 text-gray-100">Première année</h1>
<p class="text-center text-lg mb-12 text-gray-300">Voici quelques projets réalisés durant ma première année d'études.</p>

{#if projects && projects.length > 0}
    <!-- Render projects if the array is not empty -->
...
{:else}
    <p class="text-center text-lg text-gray-300">Aucun projet à afficher.</p>
{/if}
