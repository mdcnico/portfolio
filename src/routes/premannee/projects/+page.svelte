<script lang="ts">
    ...
    const projects = [
        { title: "Morpion", image: "/images/projet1.jpg", link: "/premannee/projects/morpion", description: "Description for Morpion", content: "Detailed content about Morpion goes here." },
